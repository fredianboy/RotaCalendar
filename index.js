const USERS = [
  ...
  { username: "Jaypee", password: "user1", isAdmin: false, staffName: "Jaypee",  icsFile: "jb.ics" },
  { username: "Mayena", password: "user2", isAdmin: false, staffName: "Mayena",    icsFile: "ma.ics" },
  { username: "Abdel", password: "user3", isAdmin: false, staffName: "Abdel",    icsFile: "aa.ics" },
  { username: "Chris", password: "user4", isAdmin: false, staffName: "Chris",    icsFile: "cb.ics" },
  ...
  { username: "Fred", password: "user9", isAdmin: false, staffName: "Fred",    icsFile: "fh.ics" },
  { username: "Erick", password: "user10", isAdmin: false, staffName: "Erick",    icsFile: "el.ics" },
  { username: "Trixielle", password: "user11", isAdmin: false, staffName: "Trixielle",    icsFile: "tlt.ics" },
  { username: "Grace", password: "user12", isAdmin: false, staffName: "Grace",    icsFile: "mgv.ics" },
  { username: "Jakki", password: "user13", isAdmin: false, staffName: "Jakki",    icsFile: "jy.ics" },
  { username: "Phillip", password: "manager", isAdmin: false, staffName: "Phillip",    icsFile: "pd.ics" },
